...
#SBATCH -n 2
#SBATCH -t 5:00:00
#SBATCH -J scaffold-11-bwa-alignment
...
module load bwa
# Your commands
bwa mem /home/maen5548/genome-analysis-2019/data/derived-data/scaffold-11_canu_assembly_2019-04-04/scaffold-11.contigs.fasta \
